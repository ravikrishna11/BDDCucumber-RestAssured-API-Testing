...
public class Publisher_Details  {
    ...
    public void delete_the_publisher_by_using_publisherId() {
	...
	.then()
		.statusCode(200)
		.log().all()
		.assertThat().body("message", equalTo("Publisher Deleted Successfully"))
		.extract().response();
		
		String Delete_publisher_by_publisherId = response.getBody().asString();
		System.out.println("Delete_publisher_by_publisherId: "+Delete_publisher_by_publisherId);
